...
function zapme_activate(): array
{
    ...
    try {
        ...
        $templates = [
            ...
            'TicketOpen'                => 'Olá %name%! Recebemos o seu ticket de N° %id% (%tid%) em %date% as %hour% em nosso sistema. Aguarde, em breve um de nossos atendentes irá lhe atender.',
            'TicketAdminReply'          => 'Olá %name%! O seu ticket N° %id% (%tid%) foi respondido por nossa equipe neste exato momento (%date% - %hour%). Visite sua área de cliente para conferir maiores informações.',
